...
def _build_extra_recipes():
    ...
    return [
        ...
        # ===== 西式純菜 (10 new, Western pure vegetable dishes) =====
        {"name":"蒜蓉炒法邊豆","cuisine":"西式","method":"炒","taste":"清淡","nutrition":"菜","time":8,"early":0,"spicy":0,"ingredients":"法邊豆200g,蒜蓉,牛油,鹽,黑胡椒","steps":"1. 法邊豆去頭尾，洗淨瀝乾\n2. 燒熱水加少少鹽，汆水1分鐘撈起\n3. 熱鑊落牛油爆香蒜蓉\n4. 落法邊豆大火快炒\n5. 加鹽、黑胡椒調味上碟","tips":"汆水可以保持法邊豆翠綠爽脆"},
        {"name":"忌廉菠菜","cuisine":"西式","method":"炒","taste":"濃味","nutrition":"菜","time":12,"early":0,"spicy":0,"ingredients":"菠菜300g,淡忌廉100ml,牛油,蒜蓉,鹽,黑胡椒,豆蔻粉(可選)","steps":"1. 菠菜洗淨瀝乾\n2. 熱鑊落牛油爆香蒜蓉\n3. 落菠菜大火快炒至軟身\n4. 倒入淡忌廉煮滾\n5. 加鹽、黑胡椒、豆蔻粉調味\n6. 煮至醬汁稍稠上碟","tips":"菠菜會出好多水，要先大火炒乾先落忌廉"},
        {"name":"橄欖油焗蘆筍","cuisine":"西式","method":"焗","taste":"清淡","nutrition":"菜","time":15,"early":0,"spicy":0,"ingredients":"蘆筍200g,橄欖油,蒜蓉,海鹽,黑胡椒,檸檬汁","steps":"1. 蘆筍洗淨，切去根部硬皮\n2. 排喺焗盤上\n3. 淋上橄欖油、灑蒜蓉、海鹽、黑胡椒\n4. 200°C焗10-12分鐘\n5. 上碟擠少少檸檬汁","tips":"揀幼身蘆筍更嫩，唔使去皮"},
        {"name":"芝士焗椰菜花","cuisine":"西式","method":"焗","taste":"濃味","nutrition":"菜","time":25,"early":1,"spicy":0,"ingredients":"椰菜花1個,車打芝士碎100g,牛油,麵粉,牛奶250ml,鹽,黑胡椒,芥末粉(可選)","steps":"1. 椰菜花切小朵，汆水2分鐘瀝乾\n2. 牛油+麵粉炒成roux\n3. 逐少加牛奶攪拌成白醬\n4. 加一半芝士碎、鹽、黑胡椒、芥末粉拌勻\n5. 椰菜花放入焗盤，淋上芝士白醬\n6. 灑剩餘芝士碎\n7. 200°C焗15-20分鐘至金黃","tips":"白醬要煮到夠稠先淋上椰菜花，唔係會水汪汪"},
        {"name":"黑醋炒雜菌","cuisine":"西式","method":"炒","taste":"濃味","nutrition":"菜","time":10,"early":0,"spicy":0,"ingredients":"蘑菇150g,雞髀菇1隻,杏鮑菇1隻,意大利黑醋1湯匙,牛油,蒜蓉,鹽,黑胡椒,番茜碎","steps":"1. 所有菇類抹乾淨切片\n2. 熱鑊落牛油大火爆香蒜蓉\n3. 落雜菌大火快炒至金黃出水\n4. 加黑醋繼續炒至收乾\n5. 加鹽、黑胡椒調味\n6. 灑番茜碎上碟","tips":"菇類唔好洗，用濕布抹就得，炒嗰陣先出香味"},
        {"name":"焗釀大蘑菇","cuisine":"西式","method":"焗","taste":"濃味","nutrition":"菜","time":20,"early":0,"spicy":0,"ingredients":"大蘑菇4隻,麵包糠30g,蒜蓉,番茜碎,橄欖油,巴馬臣芝士碎,鹽,黑胡椒","steps":"1. 大蘑菇去蒂，用濕布抹乾淨\n2. 麵包糠+蒜蓉+番茜+芝士碎+橄欖油+鹽+黑胡椒拌勻\n3. 釀入蘑菇傘內\n4. 焗盤掃油，放上蘑菇\n5. 200°C焗12-15分鐘至表面金黃","tips":"蘑菇唔好洗，否則焗嗰陣會出好多水"},
        {"name":"香草焗雜菜","cuisine":"西式","method":"焗","taste":"清淡","nutrition":"菜","time":30,"early":0,"spicy":0,"ingredients":"三色椒各半個,翠玉瓜1條,紫洋蔥半個,車厘茄8粒,橄欖油,迷迭香,百里香,海鹽,黑胡椒","steps":"1. 所有蔬菜洗淨切大塊\n2. 放入大碗，加橄欖油、迷迭香、百里香、鹽、黑胡椒拌勻\n3. 平鋪喺焗盤上（唔好疊住）\n4. 200°C焗20-25分鐘至蔬菜軟身邊緣微焦\n5. 中途翻面一次","tips":"蔬菜要切得大細均勻，焗出嚟先一致"},
        {"name":"蜜糖焗甘筍","cuisine":"西式","method":"焗","taste":"清淡","nutrition":"菜","time":25,"early":0,"spicy":0,"ingredients":"甘筍4條,蜜糖1湯匙,橄欖油,牛油,鹽,黑胡椒,百里香","steps":"1. 甘筍去皮，切長條\n2. 放入焗盤，淋上橄欖油、鹽、黑胡椒拌勻\n3. 200°C焗15分鐘\n4. 取出，淋上蜜糖+牛油混合物\n5. 灑百里香\n6. 再焗10分鐘至表面焦糖化","tips":"蜜糖後落可以避免焗燶，保持甜味"},
        {"name":"田園沙律","cuisine":"西式","method":"炒","taste":"清淡","nutrition":"菜","time":10,"early":1,"has_cold_dish":1,"spicy":0,"ingredients":"沙律菜200g,青瓜半條,車厘茄8粒,紫洋蔥絲,橄欖油,意大利黑醋,鹽,黑胡椒","steps":"1. 沙律菜洗淨瀝乾撕碎\n2. 青瓜切片，車厘茄切半\n3. 所有蔬菜放入大碗\n4. 橄欖油+黑醋+鹽+黑胡椒攪勻成dressing\n5. 淋上dressing拌勻上碟","tips":"沙律菜要徹底瀝乾水，dressing臨食先落保持爽脆"},
        {"name":"炒翠玉瓜絲","cuisine":"西式","method":"炒","taste":"清淡","nutrition":"菜","time":7,"early":0,"spicy":0,"ingredients":"翠玉瓜1條,蒜蓉,橄欖油,鹽,黑胡椒,檸檬汁","steps":"1. 翠玉瓜洗淨切幼絲\n2. 熱鑊落橄欖油爆香蒜蓉\n3. 落翠玉瓜絲大火快炒1-2分鐘\n4. 加鹽、黑胡椒調味\n5. 熄火擠少少檸檬汁上碟","tips":"翠玉瓜好易熟，快炒保持爽脆，唔好炒太耐"},
    ]
