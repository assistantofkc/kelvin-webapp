...
MASTER_BANK = {
    # Level 1: 基本字根 (24 Basic Roots - 100 entries)
    1: [
        # Original 24 roots
        {'char': '日', 'code': 'A', 'parts': '太陽'},
        {'char': '月', 'code': 'B', 'parts': '月亮'},
        {'char': '金', 'code': 'C', 'parts': '金屬/八'},
        {'char': '木', 'code': 'D', 'parts': '樹木'},
        {'char': '水', 'code': 'E', 'parts': '液體'},
        {'char': '火', 'code': 'F', 'parts': '火焰'},
        {'char': '土', 'code': 'G', 'parts': '土地'},
        {'char': '竹', 'code': 'H', 'parts': '撇/竹'},
        {'char': '戈', 'code': 'I', 'parts': '點/戈'},
        {'char': '十', 'code': 'J', 'parts': '十字/十字頭'},
        {'char': '大', 'code': 'K', 'parts': '叉形'},
        {'char': '中', 'code': 'L', 'parts': '豎線'},
        {'char': '一', 'code': 'M', 'parts': '橫線'},
        {'char': '弓', 'code': 'N', 'parts': '勾/彎'},
        {'char': '人', 'code': 'O', 'parts': '人形'},
        {'char': '心', 'code': 'P', 'parts': '心形/撇點'},
        {'char': '手', 'code': 'Q', 'parts': '手部'},
        {'char': '口', 'code': 'R', 'parts': '方框'},
        {'char': '尸', 'code': 'S', 'parts': '折/屍'},
        {'char': '廿', 'code': 'T', 'parts': '草頭'},
        {'char': '山', 'code': 'U', 'parts': '山形/開口'},
        {'char': '女', 'code': 'V', 'parts': '交叉/女'},
        {'char': '田', 'code': 'W', 'parts': '田字/方塊'},
        {'char': '卜', 'code': 'Y', 'parts': '點/卜'},
        # Extended practice with repeated roots
        {'char': '二', 'code': 'MM', 'parts': '橫線+橫線'},
        {'char': '三', 'code': 'MMM', 'parts': '橫線+橫線+橫線'},
        {'char': '𠂇', 'code': 'HK', 'parts': '竹+戈'},
        {'char': '十', 'code': 'JJ', 'parts': '十+十'},
        {'char': '山', 'code': 'UU', 'parts': '山+山'},
        {'char': '日', 'code': 'AA', 'parts': '日+日'},
        {'char': '月', 'code': 'BB', 'parts': '月+月'},
        {'char': '木', 'code': 'DD', 'parts': '木+木'},
        {'char': '水', 'code': 'EE', 'parts': '水+水'},
        {'char': '火', 'code': 'FF', 'parts': '火+火'},
        {'char': '土', 'code': 'GG', 'parts': '土+土'},
        {'char': '金', 'code': 'CC', 'parts': '金+金'},
        {'char': '人', 'code': 'OO', 'parts': '人+人'},
        {'char': '心', 'code': 'PP', 'parts': '心+心'},
        {'char': '手', 'code': 'QQ', 'parts': '手+手'},
        {'char': '口', 'code': 'RR', 'parts': '口+口'},
        {'char': '尸', 'code': 'SS', 'parts': '尸+尸'},
        {'char': '廿', 'code': 'TT', 'parts': '廿+廿'},
        {'char': '女', 'code': 'VV', 'parts': '女+女'},
        {'char': '田', 'code': 'WW', 'parts': '田+田'},
        {'char': '卜', 'code': 'YY', 'parts': '卜+卜'},
        {'char': '戈', 'code': 'II', 'parts': '戈+戈'},
        {'char': '弓', 'code': 'NN', 'parts': '弓+弓'},
        {'char': '竹', 'code': 'HH', 'parts': '竹+竹'},
        {'char': '中', 'code': 'LL', 'parts': '中+中'},
        {'char': '大', 'code': 'KK', 'parts': '大+大'},
        {'char': '一', 'code': 'MMMM', 'parts': '四橫'},
        {'char': '日', 'code': 'AAAA', 'parts': '四日'},
        {'char': '月', 'code': 'BBBB', 'parts': '四月'},
        {'char': '木', 'code': 'DDDD', 'parts': '四木'},
        {'char': '水', 'code': 'EEEE', 'parts': '四水'},
        {'char': '火', 'code': 'FFFF', 'parts': '四火'},
        {'char': '土', 'code': 'GGGG', 'parts': '四土'},
        {'char': '金', 'code': 'CCCC', 'parts': '四金'},
        {'char': '人', 'code': 'OOOO', 'parts': '四人'},
        {'char': '心', 'code': 'PPP', 'parts': '三心'},
        {'char': '手', 'code': 'QQQ', 'parts': '三手'},
        {'char': '口', 'code': 'RRR', 'parts': '三口'},
        {'char': '女', 'code': 'VVV', 'parts': '三女'},
        {'char': '田', 'code': 'WWW', 'parts': '三田'},
        {'char': '卜', 'code': 'YYY', 'parts': '三卜'},
        {'char': '戈', 'code': 'III', 'parts': '三戈'},
        {'char': '弓', 'code': 'NNN', 'parts': '三弓'},
        {'char': '竹', 'code': 'HHH', 'parts': '三竹'},
        {'char': '中', 'code': 'LLL', 'parts': '三中'},
        {'char': '大', 'code': 'KKK', 'parts': '三大'},
        {'char': '山', 'code': 'UUU', 'parts': '三山'},
        {'char': '十', 'code': 'JJJ', 'parts': '三十'},
        {'char': '尸', 'code': 'SSS', 'parts': '三尸'},
        {'char': '廿', 'code': 'TTT', 'parts': '三廿'},
        {'char': '日日日日', 'code': 'AAAAA', 'parts': '五日'},
        {'char': '月月月月', 'code': 'BBBBB', 'parts': '五月'},
        {'char': '木木木木', 'code': 'DDDDD', 'parts': '五木'},
        {'char': '水水水水', 'code': 'EEEEE', 'parts': '五水'},
        {'char': '火火火火', 'code': 'FFFFF', 'parts': '五火'},
        {'char': '土土土土', 'code': 'GGGGG', 'parts': '五土'},
        {'char': '金金金金', 'code': 'CCCCC', 'parts': '五金'},
        {'char': '人人人人', 'code': 'OOOOO', 'parts': '五人'},
        {'char': '心心心心', 'code': 'PPPP', 'parts': '四心'},
        {'char': '手手手手', 'code': 'QQQQ', 'parts': '四手'},
        {'char': '口口口口', 'code': 'RRRR', 'parts': '四口'},
        {'char': '女女女女', 'code': 'VVVV', 'parts': '四女'},
        {'char': '田田田田', 'code': 'WWWW', 'parts': '四田'},
        {'char': '卜卜卜卜', 'code': 'YYYY', 'parts': '四卜'},
        {'char': '戈戈戈戈', 'code': 'IIII', 'parts': '四戈'},
        {'char': '弓弓弓弓', 'code': 'NNNN', 'parts': '四弓'},
        {'char': '竹竹竹竹', 'code': 'HHHH', 'parts': '四竹'},
        {'char': '中中中中', 'code': 'LLLL', 'parts': '四中'},
        {'char': '大大大大', 'code': 'KKKKK', 'parts': '五大'},
        {'char': '山山山山', 'code': 'UUUU', 'parts': '四山'},
        {'char': '十十十十', 'code': 'JJJJ', 'parts': '四十'},
        {'char': '尸尸尸尸', 'code': 'SSSS', 'parts': '四尸'},
        {'char': '廿廿廿廿', 'code': 'TTTT', 'parts': '四廿'},
        {'char': '一', 'code': 'M', 'parts': '橫線'},
        {'char': '丨', 'code': 'J', 'parts': '豎線'},
        {'char': '丿', 'code': 'I', 'parts': '撇'},
        {'char': '丶', 'code': 'N', 'parts': '點'},
    ],
    
    # Level 2: 字根變體 (Variants - 100 entries)
    2: [
        ...
        {'char': '艹', 'code': 'T', 'parts': '草'},
        {'char': '阝', 'code': 'N', 'parts': '阜'},
    ...
    # Level 3: 常用漢字 (Combined Characters - 100 entries)
    3: [
        ...
        {'char': '力', 'code': 'S', 'parts': '力'},
        {'char': '工', 'code': 'M', 'parts': '工'},
        {'char': '作', 'code': 'OHS', 'parts': '人+乍'},
        {'char': '事', 'code': 'JLLI', 'parts': '事'},
