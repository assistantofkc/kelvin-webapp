...
MASTER_BANK = {
    # Level 1: 24 基本字根 (正確校對版)
    1: [
        {'char': '日', 'code': 'A', 'parts': '日'},
        {'char': '月', 'code': 'B', 'parts': '月'},
    ...
    3: [
        ...
        {'char': '看', 'code': 'HQU', 'parts': '手+目(山)'},
        {'char': '國', 'code': 'WGI', 'parts': '囗+戈'},
        {'char': '電', 'code': 'MBW', 'parts': '一+月+田'},
